...
var CONFIG = {
    ...
    apiHerokuUrl: 'https://safe-harbor-28237.herokuapp.com/',
...
var CommonServicesService = /** @class */ (function () {
    ...
    CommonServicesService.prototype.getApiURL = function () {
...
var GalleryComponent = /** @class */ (function () {
    ...
    GalleryComponent.prototype.onFileChange = function (event) {
        ...
        if (event.target.files && event.target.files.length > 0) {
            ...
            reader.onload = function () {
                ...
                __WEBPACK_IMPORTED_MODULE_2_jquery__('#preview').attr('src', URL.createObjectURL(event.target.files[0]));
    ...
    GalleryComponent.prototype.onDeleteClick = function (image) {
        this.modalImage = image;
        this.noteSvc.setNotification('Confirmation', 'Are you sure you want to remove ' + image.imageName + ' from the system?');
...
var NotificationComponent = /** @class */ (function () {
    ...
    NotificationComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.subscription = this.noteSvc.getNotification().subscribe(function (notification) {
